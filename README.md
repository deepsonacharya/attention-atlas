...
→ Open the course · 13 lessons · 7 live instruments · MIT licensed
...
Online: visit deepsonacharya.github.io/attention-atlas

Locally:

Clone or download this repo
Open index.html in any modern browser
Start at lesson 00, or jump to any topic via the sidebar
...
Track adoption — add your course to ADOPTERS.md with a pull request, and help other instructors discover what's working.
Contributing

Found a typo? Have a better explanation? Want to add a lesson or improve an instrument?

See CONTRIBUTING.md to get started. All contributions are welcome — from tiny corrections to new features.
...
MIT. See LICENSE for details. In short: use it, modify it, share it freely.
